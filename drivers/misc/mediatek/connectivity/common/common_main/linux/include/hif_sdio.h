...
********************************************************************************
*/
#define HIF_SDIO_DEBUG  (1)	/* 0:turn off debug msg and assert, 1:turn off debug msg and assert */
#define HIF_SDIO_API_EXTENSION      (1)
/*******************************************************************************
...
extern INT32 mtk_wcn_hif_sdio_abort(MTK_WCN_HIF_SDIO_CLTCTX ctx, UINT32 offset, PUINT32 pbuf, UINT32 len);
