...
//static unsigned char bt_get_bd_addr[4] = {0x01, 0x09, 0x10, 0x00};
static unsigned char bt_get_bd_addr_evt[] = {0x04, 0x0E, 0x0A, 0x01, 0x09, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static unsigned char bt_set_bd_addr[10] = {0x01, 0x1A, 0xFC, 0x06, 0x01, 0x20, 0x66, 0x46, 0x00, 0x00};
static unsigned char bt_set_bd_addr_evt[] = {0x04, 0x0E, 0x04, 0x01, 0x1A, 0xFC, 0x00};
static unsigned char bt_set_codec[8] = {0x01, 0x72, 0xFC, 0x04, 0x23, 0x10, 0x00, 0x00};
static unsigned char bt_set_codec_evt[] = {0x04, 0x0E, 0x04, 0x01, 0x72, 0xFC, 0x00};
static unsigned char bt_set_radio[10] = {0x01, 0x79, 0xFC, 0x06, 0x06, 0x80, 0x00, 0x06, 0x03, 0x06};
static unsigned char bt_set_radio_evt[] = {0x04, 0x0E, 0x04, 0x01, 0x79, 0xFC, 0x00};
static unsigned char bt_set_tx_pwr_offset[7] = {0x01, 0x93, 0xFC, 0x03, 0xFF, 0xFF, 0xFF};
static unsigned char bt_set_tx_pwr_offset_evt[] = {0x04, 0x0E, 0x04, 0x01, 0x93, 0xFC, 0x00};
static unsigned char bt_set_sleep[11] = {0x01, 0x7A, 0xFC, 0x07, 0x03, 0x40, 0x1F, 0x40, 0x1F, 0x00, 0x04};
static unsigned char bt_set_sleep_evt[] = {0x04, 0x0E, 0x04, 0x01, 0x7A, 0xFC, 0x00};
static unsigned char bt_set_coex_adjust[10] = {0x01, 0x22, 0xFC, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static unsigned char bt_set_coex_adjust_evt[] = {0x04, 0x0E, 0x04, 0x01, 0x22, 0xFC, 0x00};
...
void hci_stp_dev_init_rx_cb(const UINT8 *data, INT32 count)
{
    ...
    if (unlikely(!mtk_hci.hdev)) {
        BT_ERR_FUNC("null hdev!\n");
        return;
    }
    if (unlikely(!hci_get_drvdata(mtk_hci.hdev))) {
        BT_ERR_FUNC("null hci_get_drvdata(hdev)!\n");
        return;
    }

    /* get hci_stp from global variable */
    hu = hci_get_drvdata(mtk_hci.hdev);
    idx = hu->init_cmd_idx;
...
static int BT_init(void)
{
	...
	mtk_wcn_stp_register_if_rx(/*mtk_bt_hci_receive*/ hci_stp_dev_init_rx_cb);
